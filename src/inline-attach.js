...
(function(document, window) {
    ...
    window.inlineAttach = function(options, instance) {
        ...
        // BL: Have added this method to be used in place of the above, it is based on one I found here:
        // http://jsfiddle.net/bbE48/13/
        // I've added the [[B]] and [[A]] bits for removal of extraneous new lines
        // following same approach as above.
        // this is then called from this.onReceivedFile;
        // (for a couple of reasons to do with var scoping, can't do this via the callback args)
        function insertTextAtTextAreaCursor(el,text) {
        ...
        this.onReceivedFile = function(file) {
            ...
            if (result !== false) {
                ...
                insertTextAtTextAreaCursor(editor.getEl()[0], lastValue);
